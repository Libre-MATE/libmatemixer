...
#define OSS_TYPE_BACKEND (oss_backend_get_type())
#define OSS_BACKEND(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), OSS_TYPE_BACKEND, OssBackend))
#define OSS_IS_BACKEND(o) (G_TYPE_CHECK_INSTANCE_TYPE((o), OSS_TYPE_BACKEND))
#define OSS_BACKEND_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), OSS_TYPE_BACKEND, OssBackendClass))
#define OSS_IS_BACKEND_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE((k), OSS_TYPE_BACKEND))
