...
#define OSS_TYPE_SWITCH (oss_switch_get_type())
#define OSS_SWITCH(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), OSS_TYPE_SWITCH, OssSwitch))
#define OSS_IS_SWITCH(o) (G_TYPE_CHECK_INSTANCE_TYPE((o), OSS_TYPE_SWITCH))
#define OSS_SWITCH_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), OSS_TYPE_SWITCH, OssSwitchClass))
#define OSS_IS_SWITCH_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE((k), OSS_TYPE_SWITCH))
