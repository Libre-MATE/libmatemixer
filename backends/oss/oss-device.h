...
#define OSS_TYPE_DEVICE (oss_device_get_type())
#define OSS_DEVICE(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), OSS_TYPE_DEVICE, OssDevice))
#define OSS_IS_DEVICE(o) (G_TYPE_CHECK_INSTANCE_TYPE((o), OSS_TYPE_DEVICE))
#define OSS_DEVICE_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), OSS_TYPE_DEVICE, OssDeviceClass))
#define OSS_IS_DEVICE_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE((k), OSS_TYPE_DEVICE))
