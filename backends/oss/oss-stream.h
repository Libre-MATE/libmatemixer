...
#define OSS_TYPE_STREAM (oss_stream_get_type())
#define OSS_STREAM(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), OSS_TYPE_STREAM, OssStream))
#define OSS_IS_STREAM(o) (G_TYPE_CHECK_INSTANCE_TYPE((o), OSS_TYPE_STREAM))
#define OSS_STREAM_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), OSS_TYPE_STREAM, OssStreamClass))
#define OSS_IS_STREAM_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE((k), OSS_TYPE_STREAM))
