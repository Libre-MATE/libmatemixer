...
#define PULSE_TYPE_DEVICE_SWITCH (pulse_device_switch_get_type())
...
#define PULSE_DEVICE_SWITCH_CLASS(k)                      \
  (G_TYPE_CHECK_CLASS_CAST((k), PULSE_TYPE_DEVICE_SWITCH, \
                           PulseDeviceSwitchClass))
...
#define PULSE_DEVICE_SWITCH_GET_CLASS(o)                    \
  (G_TYPE_INSTANCE_GET_CLASS((o), PULSE_TYPE_DEVICE_SWITCH, \
                             PulseDeviceSwitchClass))
