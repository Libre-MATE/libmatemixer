...
#define PULSE_TYPE_CONNECTION (pulse_connection_get_type())
...
struct _PulseConnectionClass {
  ...
  /*< private >*/
  void (*server_info)(PulseConnection *connection, const pa_server_info *info);

  void (*card_info)(PulseConnection *connection, const pa_card_info *info);
  void (*card_removed)(PulseConnection *connection, guint32 index);

  void (*sink_info)(PulseConnection *connection, const pa_sink_info *info);
  void (*sink_removed)(PulseConnection *connection, guint32 index);

  void (*sink_input_info)(PulseConnection *connection,
                          const pa_sink_input_info *info);
  void (*sink_input_removed)(PulseConnection *connection, guint32 index);

  void (*source_info)(PulseConnection *connection, const pa_source_info *info);
  void (*source_removed)(PulseConnection *connection, guint32 index);

  void (*source_output_info)(PulseConnection *connection,
                             const pa_source_output_info *info);
  void (*source_output_removed)(PulseConnection *connection, guint32 index);
