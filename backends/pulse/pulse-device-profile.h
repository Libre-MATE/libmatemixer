...
#define PULSE_TYPE_DEVICE_PROFILE (pulse_device_profile_get_type())
#define PULSE_DEVICE_PROFILE(o)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((o), PULSE_TYPE_DEVICE_PROFILE, \
                              PulseDeviceProfile))
...
#define PULSE_DEVICE_PROFILE_CLASS(k)                      \
  (G_TYPE_CHECK_CLASS_CAST((k), PULSE_TYPE_DEVICE_PROFILE, \
                           PulseDeviceProfileClass))
...
#define PULSE_DEVICE_PROFILE_GET_CLASS(o)                  \
  (G_TYPE_INSTANCE_GET_CLASS((o), PULSE_IS_DEVICE_PROFILE, \
                             PulseDeviceProfileClass))
