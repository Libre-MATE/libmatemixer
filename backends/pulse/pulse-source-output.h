...
#define PULSE_TYPE_SOURCE_OUTPUT (pulse_source_output_get_type())
...
#define PULSE_SOURCE_OUTPUT_CLASS(k)                      \
  (G_TYPE_CHECK_CLASS_CAST((k), PULSE_TYPE_SOURCE_OUTPUT, \
...
#define PULSE_SOURCE_OUTPUT_GET_CLASS(o)                    \
  (G_TYPE_INSTANCE_GET_CLASS((o), PULSE_TYPE_SOURCE_OUTPUT, \
                             PulseSourceOutputClass))
