...
#define ALSA_TYPE_STREAM (alsa_stream_get_type())
#define ALSA_STREAM(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), ALSA_TYPE_STREAM, AlsaStream))
#define ALSA_IS_STREAM(o) (G_TYPE_CHECK_INSTANCE_TYPE((o), ALSA_TYPE_STREAM))
#define ALSA_STREAM_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), ALSA_TYPE_STREAM, AlsaStreamClass))
#define ALSA_IS_STREAM_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE((k), ALSA_TYPE_STREAM))
