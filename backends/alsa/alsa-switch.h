...
#define ALSA_TYPE_SWITCH (alsa_switch_get_type())
#define ALSA_SWITCH(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), ALSA_TYPE_SWITCH, AlsaSwitch))
#define ALSA_IS_SWITCH(o) (G_TYPE_CHECK_INSTANCE_TYPE((o), ALSA_TYPE_SWITCH))
#define ALSA_SWITCH_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), ALSA_TYPE_SWITCH, AlsaSwitchClass))
#define ALSA_IS_SWITCH_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE((k), ALSA_TYPE_SWITCH))
