...
#define ALSA_TYPE_DEVICE (alsa_device_get_type())
#define ALSA_DEVICE(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), ALSA_TYPE_DEVICE, AlsaDevice))
#define ALSA_IS_DEVICE(o) (G_TYPE_CHECK_INSTANCE_TYPE((o), ALSA_TYPE_DEVICE))
#define ALSA_DEVICE_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), ALSA_TYPE_DEVICE, AlsaDeviceClass))
#define ALSA_IS_DEVICE_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE((k), ALSA_TYPE_DEVICE))
