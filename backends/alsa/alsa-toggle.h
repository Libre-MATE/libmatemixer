...
typedef enum { ALSA_TOGGLE_CAPTURE, ALSA_TOGGLE_PLAYBACK } AlsaToggleType;

#define ALSA_TYPE_TOGGLE (alsa_toggle_get_type())
#define ALSA_TOGGLE(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), ALSA_TYPE_TOGGLE, AlsaToggle))
#define ALSA_IS_TOGGLE(o) (G_TYPE_CHECK_INSTANCE_TYPE((o), ALSA_TYPE_TOGGLE))
#define ALSA_TOGGLE_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), ALSA_TYPE_TOGGLE, AlsaToggleClass))
#define ALSA_IS_TOGGLE_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE((k), ALSA_TYPE_TOGGLE))
