...
#define ALSA_TYPE_STREAM_CONTROL (alsa_stream_control_get_type())
...
#define ALSA_STREAM_CONTROL_CLASS(k)                      \
  (G_TYPE_CHECK_CLASS_CAST((k), ALSA_TYPE_STREAM_CONTROL, \
                           AlsaStreamControlClass))
...
#define ALSA_STREAM_CONTROL_GET_CLASS(o)                    \
  (G_TYPE_INSTANCE_GET_CLASS((o), ALSA_TYPE_STREAM_CONTROL, \
                             AlsaStreamControlClass))
...
struct _AlsaStreamControlClass {
  ...
  gboolean (*set_mute)(AlsaStreamControl *control, gboolean mute);

  gboolean (*set_volume)(AlsaStreamControl *control, guint volume);
  ...
  gboolean (*get_volume_from_decibel)(AlsaStreamControl *control,
                                      gdouble decibel, guint *volume);

  gboolean (*get_decibel_from_volume)(AlsaStreamControl *control, guint volume,
                                      gdouble *decibel);
};
