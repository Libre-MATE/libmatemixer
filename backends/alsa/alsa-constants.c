...
/*
 * These lists of ALSA mixer elements are based on PulseAudio's mixer paths and
 * own observations. The intention is to provide translatable and in some cases
 * better readable labels and role assignments. The controls list is also used
 * for selecting the default controls and the selection machanism relies on the
 * order of elements, so more useful elements should be placed on the top. The
 * last two boolean values indicate whether we prefer the element to be used as
 * a default input or output control.
 *
 * Of course the lists are very incomplete and it would be great if users
 * validated and refreshed them from time to time.
 */
const AlsaControlInfo alsa_controls[] = {
    /* Output controls */
    {"Master", N_("Master"), MATE_MIXER_STREAM_CONTROL_ROLE_MASTER, FALSE,
     TRUE},
    {"Hardware Master", N_("Hardware Master"),
     MATE_MIXER_STREAM_CONTROL_ROLE_MASTER, FALSE, TRUE},
    {"PCM", N_("PCM"), MATE_MIXER_STREAM_CONTROL_ROLE_PCM, FALSE, TRUE},
    {"Speaker", N_("Speaker"), MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER, FALSE,
     TRUE},
    {"Desktop Speaker", N_("Desktop Speaker"),
     MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER, FALSE, TRUE},
    {"Front", N_("Front Speaker"), MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER,
     FALSE, TRUE},
    {"Front Speaker", N_("Front Speaker"),
     MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER, FALSE, TRUE},
    {"Speaker Front", N_("Front Speaker"),
     MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER, FALSE, TRUE},
    {"Headphone", N_("Headphone"), MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER,
     FALSE, TRUE},
    {"Headphone2", N_("Headphone 2"), MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER,
     FALSE, TRUE},
    {"Headset", N_("Headset"), MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER, FALSE,
     TRUE},
    {"Master Surround", N_("Surround Speaker"),
     MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER, FALSE, TRUE},
    {"Surround", N_("Surround Speaker"), MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER,
     FALSE, TRUE},
    {"Surround Speaker", N_("Surround Speaker"),
     MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER, FALSE, TRUE},
    {"Speaker Surround", N_("Surround Speaker"),
     MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER, FALSE, TRUE},
    {"Center", N_("Center Speaker"), MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER,
     FALSE, TRUE},
    {"Center Speaker", N_("Center Speaker"),
     MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER, FALSE, TRUE},
    {"CLFE", N_("CLFE Speaker"), MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER, FALSE,
     TRUE},
    {"Speaker CLFE", N_("CLFE Speaker"), MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER,
     FALSE, TRUE},
    {"Digital/SPDIF", N_("Digital"), MATE_MIXER_STREAM_CONTROL_ROLE_PORT, FALSE,
     TRUE},
    {"Master Mono", N_("Master Mono"), MATE_MIXER_STREAM_CONTROL_ROLE_MASTER,
     FALSE, TRUE},
    {"Master Digital", N_("Master Digital"),
     MATE_MIXER_STREAM_CONTROL_ROLE_MASTER, FALSE, TRUE},
    {"Speaker Side", N_("Side Speaker"), MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER,
     FALSE, TRUE},
    {"Side", N_("Side Speaker"), MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER, FALSE,
     TRUE},
    {"Rear", N_("Rear Speaker"), MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER, FALSE,
     TRUE},
    ...
    {"LFE", N_("LFE Speaker"), MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER, FALSE,
     FALSE},
    {"LFE Speaker", N_("LFE Speaker"), MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER,
     FALSE, FALSE},
    {"Bass Speaker", N_("Bass Speaker"), MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER,
     FALSE, FALSE},
    {"PC Speaker", N_("PC Speaker"), MATE_MIXER_STREAM_CONTROL_ROLE_SPEAKER,
     FALSE, FALSE},
    {"Synth", N_("Synth"), MATE_MIXER_STREAM_CONTROL_ROLE_UNKNOWN, FALSE,
     FALSE},
    {"MIDI", N_("MIDI"), MATE_MIXER_STREAM_CONTROL_ROLE_UNKNOWN, FALSE, FALSE},
    {"Synth/MIDI", N_("Synth/MIDI"), MATE_MIXER_STREAM_CONTROL_ROLE_UNKNOWN,
     FALSE, FALSE},
    {"Bass", N_("Bass"), MATE_MIXER_STREAM_CONTROL_ROLE_BASS, FALSE, FALSE},
    {"Treble", N_("Treble"), MATE_MIXER_STREAM_CONTROL_ROLE_TREBLE, FALSE,
     FALSE},

    /* Input controls */
    {"Capture", N_("Capture"), MATE_MIXER_STREAM_CONTROL_ROLE_MASTER, TRUE,
     FALSE},
    {"Mic", N_("Microphone"), MATE_MIXER_STREAM_CONTROL_ROLE_MICROPHONE, TRUE,
     FALSE},
    {"Mic/Line", N_("Microphone/Line In"), MATE_MIXER_STREAM_CONTROL_ROLE_PORT,
     TRUE, FALSE},
    {"Internal Mic", N_("Internal Microphone"),
     MATE_MIXER_STREAM_CONTROL_ROLE_MICROPHONE, TRUE, FALSE},
    {"Int Mic", N_("Internal Microphone"),
     MATE_MIXER_STREAM_CONTROL_ROLE_MICROPHONE, TRUE, FALSE},
    {"Front Mic", N_("Front Microphone"),
     MATE_MIXER_STREAM_CONTROL_ROLE_MICROPHONE, TRUE, FALSE},
    {"Rear Mic", N_("Rear Microphone"),
     MATE_MIXER_STREAM_CONTROL_ROLE_MICROPHONE, TRUE, FALSE},
    {"Dock Mic", N_("Dock Microphone"),
     MATE_MIXER_STREAM_CONTROL_ROLE_MICROPHONE, TRUE, FALSE},
    {"Headphone Mic", N_("Headphone Microphone"),
     MATE_MIXER_STREAM_CONTROL_ROLE_MICROPHONE, TRUE, FALSE},
    {"Headset Mic", N_("Headset Microphone"),
     MATE_MIXER_STREAM_CONTROL_ROLE_MICROPHONE, TRUE, FALSE},
    {"Inverted Internal Mic", N_("Inverted Internal Microphone"),
     MATE_MIXER_STREAM_CONTROL_ROLE_MICROPHONE, TRUE, FALSE},
    {"Line", N_("Line In"), MATE_MIXER_STREAM_CONTROL_ROLE_PORT, TRUE, FALSE},
    {"Line in", N_("Line In"), MATE_MIXER_STREAM_CONTROL_ROLE_PORT, TRUE,
     FALSE},
    {"Line In", N_("Line In"), MATE_MIXER_STREAM_CONTROL_ROLE_PORT, TRUE,
     FALSE},
    ...
    {"TV Tuner", N_("TV Tuner"), MATE_MIXER_STREAM_CONTROL_ROLE_UNKNOWN, TRUE,
     FALSE},
    ...
    {"Mic Boost", N_("Microphone Boost"), MATE_MIXER_STREAM_CONTROL_ROLE_BOOST,
     FALSE, FALSE},
    {"Mic Boost (+20dB)", N_("Microphone Boost (+20dB)"),
     MATE_MIXER_STREAM_CONTROL_ROLE_BOOST, FALSE, FALSE},
    {"Int Mic Boost", N_("Internal Microphone Boost"),
     MATE_MIXER_STREAM_CONTROL_ROLE_BOOST, FALSE, FALSE},
    {"Internal Mic Boost", N_("Internal Microphone Boost"),
     MATE_MIXER_STREAM_CONTROL_ROLE_BOOST, FALSE, FALSE},
    {"Front Mic Boost", N_("Front Microphone Boost"),
     MATE_MIXER_STREAM_CONTROL_ROLE_BOOST, FALSE, FALSE},
    {"Rear Mic Boost", N_("Rear Microphone Boost"),
     MATE_MIXER_STREAM_CONTROL_ROLE_BOOST, FALSE, FALSE},
    {"Dock Mic Boost", N_("Dock Microphone Boost"),
     MATE_MIXER_STREAM_CONTROL_ROLE_BOOST, FALSE, FALSE},
    {"Headphone Mic Boost", N_("Headphone Microphone Boost"),
     MATE_MIXER_STREAM_CONTROL_ROLE_BOOST, FALSE, FALSE},
    {"Headset Mic Boost", N_("Headset Microphone Boost"),
     MATE_MIXER_STREAM_CONTROL_ROLE_BOOST, FALSE, FALSE},
    {"Line Boost", N_("Line In Boost"), MATE_MIXER_STREAM_CONTROL_ROLE_BOOST,
     FALSE, FALSE},
    {NULL}};
...
const AlsaSwitchInfo alsa_switches[] = {
    ...
    {"Capture Source", N_("Capture Source"),
     MATE_MIXER_STREAM_SWITCH_ROLE_PORT},
    {"Input Source", N_("Input Source"), MATE_MIXER_STREAM_SWITCH_ROLE_PORT},
    {"Input Source Select", N_("Input Source"),
     MATE_MIXER_STREAM_SWITCH_ROLE_PORT},
    {"Digital Input Source", N_("Digital Input Source"),
     MATE_MIXER_STREAM_SWITCH_ROLE_PORT},
    {"PCM Capture Source", N_("PCM Capture Source"),
     MATE_MIXER_STREAM_SWITCH_ROLE_PORT},
    {"IEC958 Playback Source", N_("Digital Playback Source"),
     MATE_MIXER_STREAM_SWITCH_ROLE_PORT},
    {"Mono Output Select", N_("Mono Output"),
     MATE_MIXER_STREAM_SWITCH_ROLE_PORT},
    {"Shared Mic/Line in", N_("Shared Microphone/Line In"),
     MATE_MIXER_STREAM_SWITCH_ROLE_PORT},
    {"Mic Select", N_("Microphone"), MATE_MIXER_STREAM_SWITCH_ROLE_PORT},
    {"Mic Jack Mode", N_("Microphone Jack Mode"),
     MATE_MIXER_STREAM_SWITCH_ROLE_PORT},
    {"Surround Jack Mode", N_("Surround Jack Mode"),
     MATE_MIXER_STREAM_SWITCH_ROLE_UNKNOWN},
    {"Auto-Mute Mode", N_("Auto-Mute Mode"),
     MATE_MIXER_STREAM_SWITCH_ROLE_UNKNOWN},

    /* Toggles */
    {"External Amplifier", N_("External Amplifier"),
     MATE_MIXER_STREAM_SWITCH_ROLE_UNKNOWN},
