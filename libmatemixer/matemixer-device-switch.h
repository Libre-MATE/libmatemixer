...
#define MATE_MIXER_TYPE_DEVICE_SWITCH (mate_mixer_device_switch_get_type())
#define MATE_MIXER_DEVICE_SWITCH(o)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((o), MATE_MIXER_TYPE_DEVICE_SWITCH, \
...
#define MATE_MIXER_DEVICE_SWITCH_CLASS(k)                      \
  (G_TYPE_CHECK_CLASS_CAST((k), MATE_MIXER_TYPE_DEVICE_SWITCH, \
...
#define MATE_MIXER_DEVICE_SWITCH_GET_CLASS(o)                    \
  (G_TYPE_INSTANCE_GET_CLASS((o), MATE_MIXER_TYPE_DEVICE_SWITCH, \
                             MateMixerDeviceSwitchClass))
 ...
 * MateMixerDeviceSwitch:
 *
 * The #MateMixerDeviceSwitch structure contains only private data and should
...
MateMixerDevice *mate_mixer_device_switch_get_device(
    MateMixerDeviceSwitch *swtch);
