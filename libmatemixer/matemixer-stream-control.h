...
#define MATE_MIXER_TYPE_STREAM_CONTROL (mate_mixer_stream_control_get_type())
#define MATE_MIXER_STREAM_CONTROL(o)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((o), MATE_MIXER_TYPE_STREAM_CONTROL, \
...
#define MATE_MIXER_STREAM_CONTROL_CLASS(k)                      \
  (G_TYPE_CHECK_CLASS_CAST((k), MATE_MIXER_TYPE_STREAM_CONTROL, \
...
#define MATE_MIXER_STREAM_CONTROL_GET_CLASS(o)                    \
  (G_TYPE_INSTANCE_GET_CLASS((o), MATE_MIXER_TYPE_STREAM_CONTROL, \
                             MateMixerStreamControlClass))
 ...
 * MateMixerStreamControl:
 *
 * The #MateMixerStreamControl structure contains only private data and should
...
struct _MateMixerStreamControlClass {
  ...
  gboolean (*set_mute)(MateMixerStreamControl *control, gboolean mute);

  guint (*get_num_channels)(MateMixerStreamControl *control);

  guint (*get_volume)(MateMixerStreamControl *control);
  gboolean (*set_volume)(MateMixerStreamControl *control, guint volume);

  gdouble (*get_decibel)(MateMixerStreamControl *control);
  gboolean (*set_decibel)(MateMixerStreamControl *control, gdouble decibel);

  gboolean (*has_channel_position)(MateMixerStreamControl *control,
                                   MateMixerChannelPosition position);
  MateMixerChannelPosition (*get_channel_position)(
      MateMixerStreamControl *control, guint channel);

  guint (*get_channel_volume)(MateMixerStreamControl *control, guint channel);
  gboolean (*set_channel_volume)(MateMixerStreamControl *control, guint channel,
                                 guint volume);

  gdouble (*get_channel_decibel)(MateMixerStreamControl *control,
                                 guint channel);
  gboolean (*set_channel_decibel)(MateMixerStreamControl *control,
                                  guint channel, gdouble decibel);

  gboolean (*set_balance)(MateMixerStreamControl *control, gfloat balance);

  gboolean (*set_fade)(MateMixerStreamControl *control, gfloat fade);
