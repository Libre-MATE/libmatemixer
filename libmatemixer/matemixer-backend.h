...
#define MATE_MIXER_TYPE_BACKEND (mate_mixer_backend_get_type())
...
#define MATE_MIXER_BACKEND_GET_CLASS(o)                    \
  (G_TYPE_INSTANCE_GET_CLASS((o), MATE_MIXER_TYPE_BACKEND, \
                             MateMixerBackendClass))
...
struct _MateMixerBackendClass {
  ...
  /*< private >*/
  void (*set_app_info)(MateMixerBackend *backend, MateMixerAppInfo *info);
  void (*set_server_address)(MateMixerBackend *backend, const gchar *address);
  ...
  /* Signals */
  void (*device_added)(MateMixerBackend *backend, const gchar *name);
  void (*device_removed)(MateMixerBackend *backend, const gchar *name);
  void (*stream_added)(MateMixerBackend *backend, const gchar *name);
  void (*stream_removed)(MateMixerBackend *backend, const gchar *name);
  void (*stored_control_added)(MateMixerBackend *backend, const gchar *name);
  void (*stored_control_removed)(MateMixerBackend *backend, const gchar *name);
};
