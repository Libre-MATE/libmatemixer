...
#define MATE_MIXER_TYPE_SWITCH_OPTION (mate_mixer_switch_option_get_type())
#define MATE_MIXER_SWITCH_OPTION(o)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((o), MATE_MIXER_TYPE_SWITCH_OPTION, \
...
#define MATE_MIXER_SWITCH_OPTION_CLASS(k)                      \
  (G_TYPE_CHECK_CLASS_CAST((k), MATE_MIXER_TYPE_SWITCH_OPTION, \
...
#define MATE_MIXER_SWITCH_OPTION_GET_CLASS(o)                    \
  (G_TYPE_INSTANCE_GET_CLASS((o), MATE_MIXER_TYPE_SWITCH_OPTION, \
                             MateMixerSwitchOptionClass))
 ...
 * MateMixerSwitchOption:
 *
 * The #MateMixerSwitchOption structure contains only private data and should
