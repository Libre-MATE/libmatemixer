...
G_DEFINE_TYPE_WITH_PRIVATE(MateMixerSwitchOption, mate_mixer_switch_option,
                           G_TYPE_OBJECT)

static void mate_mixer_switch_option_class_init(
    MateMixerSwitchOptionClass *klass) {
  ...
  properties[PROP_NAME] = g_param_spec_string(
      "name", "Name", "Name of the switch option", NULL,
  ...
  properties[PROP_LABEL] = g_param_spec_string(
      "label", "Label", "Label of the switch option", NULL,
      G_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY | G_PARAM_STATIC_STRINGS);
  ...
  properties[PROP_ICON] = g_param_spec_string(
      "icon", "Icon", "Icon of the switch option", NULL,
      G_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY | G_PARAM_STATIC_STRINGS);
 ...
 * of a particular #MateMixerSwitch and may be used to get the
 * #MateMixerSwitchOption using mate_mixer_switch_get_option().
 *
...
MateMixerSwitchOption *_mate_mixer_switch_option_new(const gchar *name,
                                                     const gchar *label,
                                                     const gchar *icon) {
  return g_object_new(MATE_MIXER_TYPE_SWITCH_OPTION, "name", name, "label",
