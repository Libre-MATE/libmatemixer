...
#define MATE_MIXER_TYPE_STREAM_TOGGLE (mate_mixer_stream_toggle_get_type())
#define MATE_MIXER_STREAM_TOGGLE(o)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((o), MATE_MIXER_TYPE_STREAM_TOGGLE, \
...
#define MATE_MIXER_STREAM_TOGGLE_CLASS(k)                      \
  (G_TYPE_CHECK_CLASS_CAST((k), MATE_MIXER_TYPE_STREAM_TOGGLE, \
...
#define MATE_MIXER_STREAM_TOGGLE_GET_CLASS(o)                    \
  (G_TYPE_INSTANCE_GET_CLASS((o), MATE_MIXER_TYPE_STREAM_TOGGLE, \
                             MateMixerStreamToggleClass))
 ...
 * MateMixerStreamToggle:
 *
 * The #MateMixerStreamToggle structure contains only private data and should
