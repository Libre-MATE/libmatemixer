...
#define MATE_MIXER_TYPE_DEVICE (mate_mixer_device_get_type())
...
struct _MateMixerDeviceClass {
  ...
  /*< private >*/
  MateMixerStream *(*get_stream)(MateMixerDevice *device, const gchar *name);
  ...
  /* Signals */
  void (*stream_added)(MateMixerDevice *device, const gchar *name);
  void (*stream_removed)(MateMixerDevice *device, const gchar *name);
  void (*switch_added)(MateMixerDevice *device, const gchar *name);
  void (*switch_removed)(MateMixerDevice *device, const gchar *name);
};
